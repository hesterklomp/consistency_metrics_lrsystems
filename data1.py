...
# Unpack data
log_data_SS = []
with open('C:\\Users\\heste\\OneDrive\\Documents\\TU Delft\\THESIS\\Data + Code\\data_thesis\\data1\\LLR_KM.csv', newline='') as csvfile:    # Create a CSV reader object
...
log_data_DS = []
with open('C:\\Users\\heste\\OneDrive\\Documents\\TU Delft\\THESIS\\Data + Code\\data_thesis\\data1\\LLR_KNM.csv', newline='') as csvfile:    # Create a CSV reader object
    csv_reader = csv.reader(csvfile)
