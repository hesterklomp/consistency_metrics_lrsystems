...
# Unpack data
log_data_SS = []
with open('C:\\Users\\heste\\OneDrive\\Documents\\TU Delft\\THESIS\\Data + Code\\data_thesis\\data7\\10LLRssame.csv',
          newline='') as csvfile:
    ...
    for row in csv_reader:
        log_data_SS.append(float(row[1]))

log_data_DS = []
with open('C:\\Users\\heste\\OneDrive\\Documents\\TU Delft\\THESIS\\Data + Code\\data_thesis\\data7\\10LLRsdif.csv',
          newline='') as csvfile:
    # Create a CSV reader object
    csv_reader = csv.reader(csvfile)
    ...
    # Iterate over each row in the CSV file
    for row in csv_reader:
        log_data_DS.append(float(row[1]))
